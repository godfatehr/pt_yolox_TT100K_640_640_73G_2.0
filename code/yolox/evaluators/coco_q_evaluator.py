...
from yolox.evaluators.coco_evaluator import per_class_AP_table, per_class_AR_table, plot_precision_recall_curves
...
class COCOQEvaluator:
    ...
    def evaluate(
        ...
        qunat_model = quant_model.eval()
        float_model = float_model.eval()
        if half:
            quant_model = quant_model.half()
        ids = []
        data_list = []
        ...
        for cur_iter, (imgs, _, info_imgs, ids) in enumerate(
            ...
            with torch.no_grad():
                ...
                if is_parallel(float_model):
                    ...
                    outputs = float_model.head.postprocess(outputs)
