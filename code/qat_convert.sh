...
WEIGHTS=./YOLOX_outputs/nano_intubot_qat/best_ckpt.pth #PATH_TO_MODEL
...
CVT_DIR=converted_qat_results/nano_intubot_qat
...
Q_DIR=${CVT_DIR}
CFG=exps/example/custom/nano_intubot_quant.py #=exps/example/custom/yolox_m_tt100k_quant.py
WEIGHTS=converted_qat_results/nano_intubot_qat/converted_qat.pth
